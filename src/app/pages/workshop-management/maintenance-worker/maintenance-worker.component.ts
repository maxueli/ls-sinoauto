...
import { maintenance, repairOrderInfoDto, dispatchingParamDto } from '../workshop-management';
import { MaintenanceWorkereService } from './maintenance-worker.service';
import { ModalDirective } from 'ngx-bootstrap/modal';

@Component({
    moduleId: module.id,
    selector: 'maintenance-worker',
    templateUrl: 'maintenance-worker.component.html',
    styleUrls: ['maintenance-worker.component.scss'],
    animations: [flyIn]
})
